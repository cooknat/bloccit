...
RSpec.describe QuestionsController, type: :controller do
  ...
  let(:my_q) { Question.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: false ) }
  ...
  describe "PUT update" do
     it "updates question with expected attributes" do
       ...
       put :update, params: { id: my_q.id, question: {title: new_title, body: new_body, resolved: false } }
     ...
     it "redirects to the updated q" do
       new_title = RandomData.random_sentence
       new_body = RandomData.random_paragraph
       new_resolved = false

       put :update, params: { id: my_q.id, question: {title: new_title, body: new_body, resolved: new_resolved } }
